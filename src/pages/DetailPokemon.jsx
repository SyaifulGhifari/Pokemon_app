...
function DetailPokemon() {
  ...
  function skill(moves) {
    let move = [];
    for (let index = 0; index < moves?.length && index < 16; index++) {
  ...
  return (
    <div className='bg-sky-400 h-full xl:h-screen  pb-5'>
      <Navbar />
      <div className='w-2/3 mx-auto'>
        <GrCaretPrevious
          size='3rem'
          onClick={handleClickBack}
          className={`fixed top-1/2 left-1 md:left-5 lg:left-20 cursor-pointer`}
        />
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
          ...
          <div className='bg-yellow-500 h-full border-4 border-blue-600 p-6'>
